        ...
        <div className='order-cart-item'>
            {props.orders.map((el) => (
                <div className='Item' key={el.id}>
                    ...
                    <button onClick={() => { props.onDelete(el.id) }} className='close-box'><FaTimes className='close' /></button>
                </div>
            ))}
        ...
        <div className='favorite-cart-item'>
            {props.favorite.map((el) => (
                <div className='Item' key={el.id}>
                    ...
                    <button onClick={() => { props.onDelete1(el.id) }} className='close-box'><FaTimes className='close' /></button>
                </div>
            ))}
        </div>
    )
